...
export const metadata: Metadata = {
  title: "Biochar Market Growth 2026: Real Numbers | iNBIO",
  description:
    "Biochar market growth in 2026 is accelerating fast. Raj Kathuria breaks down the real data, who&apos;s buying, and where the margins actually are.",
};

export default function BlogPostBiocharMarketGrowth2026() {
  return (
    <>
      {/* Hero */}
      ...
      <article className="py-12 sm:py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10 rounded-xl bg-surface-dark border border-border h-64 sm:h-80 flex items-center justify-center">
            <p className="text-text-lighter text-sm">Featured image: Biochar Market Growth in 2026: What the Numbers Actually Mean</p>
          </div>
      ...
      <section className="py-16 bg-primary-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white">Want a Realistic Project Economics Model for Your Feedstock?</h2>
          <p className="mt-4 text-lg text-white/80 max-w-xl mx-auto">We&apos;ll walk through feedstock availability, system sizing, biochar and carbon credit revenue projections, and capital costs — no sales pitch, just the numbers. Reach out to the iNBIO team in Salisbury to set up a working session.</p>
          <Link
            href="/contact"
